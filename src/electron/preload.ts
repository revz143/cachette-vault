...
const api: CachetteApi = {
  ...
  lockVault: (options?: { forget?: boolean }) => ipcRenderer.invoke("vault:lock", options),
  autoUnlock: () => ipcRenderer.invoke("vault:auto-unlock"),
  rememberStatus: () => ipcRenderer.invoke("remember:status"),
  enableRemember: () => ipcRenderer.invoke("remember:enable"),
  disableRemember: () => ipcRenderer.invoke("remember:disable"),
